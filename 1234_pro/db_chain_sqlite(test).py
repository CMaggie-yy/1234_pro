...
# res = db.run("""
# SELECT "采购人名称" FROM "call_bid_info" WHERE "包名称" = 'CT机'
# """)
# print(res)
...
# res1 = write_query_chain.invoke({"question": "请帮我查询表格前10条项目名称"}).split("SQLResult")[0]
# res1 = write_query_chain.invoke({"question": "请帮我查询上海市老年医学中心的所有项目名称"})
# res1 = write_query_chain.invoke({"question": "请帮我查询项目名称前10条"})
...
# chain = write_query_chain | execute_query_chain
